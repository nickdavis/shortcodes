 ...
 * @since 1.3.0
 *
 * @param string $pathto_configuration_file Absolute path to the configuration
 * file's location
 *
 * @return array
 */
...
function process_the_shortcode_callback( $user_defined_attributes, $content, $shortcode_name ) {
	...
	if ( $config['processing_function'] ) {
		// As long as function is callable you can assign a function to a
		// variable name and run it.
...
/**
 * Store the shortcode runtime configuration parameters into the static store.
 *
 * @since 1.3.0
 *
 * @param string $shortcode_name Name of the shortcode
